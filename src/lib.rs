...
struct ControlBlock {
    shape: ControlArray,
    pulse_width: ControlArray,
    osc1_warp_amount: ControlArray,
    osc1_custom_shape: ControlArray,
    osc1_cents: ControlArray,
    osc1_curve_fade: ControlArray,
    osc1_level: ControlArray,
    osc1_pan: ControlArray,
    osc2_shape: ControlArray,
    osc2_pulse_width: ControlArray,
    osc2_warp_amount: ControlArray,
    osc2_custom_shape: ControlArray,
    osc2_cents: ControlArray,
    osc2_curve_fade: ControlArray,
    osc2_level: ControlArray,
    osc2_pan: ControlArray,
    osc3_shape: ControlArray,
    osc3_pulse_width: ControlArray,
    osc3_warp_amount: ControlArray,
    osc3_custom_shape: ControlArray,
    osc3_cents: ControlArray,
    osc3_curve_fade: ControlArray,
    osc3_level: ControlArray,
    osc3_pan: ControlArray,
    velocity: ControlArray,
    pressure: ControlArray,
    timbre: ControlArray,
    attack: ControlArray,
    decay: ControlArray,
    sustain: ControlArray,
    release: ControlArray,
    attack_curve: ControlArray,
    decay_curve: ControlArray,
    release_curve: ControlArray,
    attack_curve_time: ControlArray,
    decay_curve_time: ControlArray,
    release_curve_time: ControlArray,
    glide_time: ControlArray,
    pitch_bend: ControlArray,
...
impl Default for ControlBlock {
    fn default() -> Self {
        Self {
            shape: control_array(0.0),
            pulse_width: control_array(0.0),
            osc1_warp_amount: control_array(0.0),
            osc1_custom_shape: control_array(0.0),
            osc1_cents: control_array(0.0),
            osc1_curve_fade: control_array(1.0),
            osc1_level: control_array(0.0),
            osc1_pan: control_array(0.0),
            osc2_shape: control_array(0.0),
            osc2_pulse_width: control_array(0.0),
            osc2_warp_amount: control_array(0.0),
            osc2_custom_shape: control_array(0.0),
            osc2_cents: control_array(0.0),
            osc2_curve_fade: control_array(1.0),
            osc2_level: control_array(0.0),
            osc2_pan: control_array(0.0),
            osc3_shape: control_array(0.0),
            osc3_pulse_width: control_array(0.0),
            osc3_warp_amount: control_array(0.0),
            osc3_custom_shape: control_array(0.0),
            osc3_cents: control_array(0.0),
            osc3_curve_fade: control_array(1.0),
            osc3_level: control_array(0.0),
            osc3_pan: control_array(0.0),
            velocity: control_array(0.0),
            pressure: control_array(0.0),
            timbre: control_array(0.0),
            attack: control_array(0.0),
            decay: control_array(0.0),
            sustain: control_array(0.0),
            release: control_array(0.0),
            attack_curve: control_array(0.0),
            decay_curve: control_array(0.0),
            release_curve: control_array(0.0),
            attack_curve_time: control_array(0.0),
            decay_curve_time: control_array(0.0),
            release_curve_time: control_array(0.0),
            glide_time: control_array(0.0),
            pitch_bend: control_array(0.0),
...
pub struct KurvDspState {
    ...
    generator_topology_generation: u32,
    generator_oscillator_generation: u32,
...
impl Default for KurvDspState {
    fn default() -> Self {
        ...
        let state = Self {
            ...
            generator_topology_generation: u32::MAX,
            generator_oscillator_generation: 0,
