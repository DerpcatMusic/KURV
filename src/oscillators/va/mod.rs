...
use antialias::{
    ...
    bandlimited_triangle4, bandlimited_triangle8, cosine_phase4, cosine_phase8, edge_blep,
    edge_blep4, edge_blep8, sine_cosine_phase4, sine_cosine_phase8, sine_phase4, sine_phase8,
    spline_blep4_precomputed, spline_blep8_precomputed,
    spline_blep8_precomputed_static_with_bounds, spline_saw8_narrow, spline_triangle4_precomputed,
    spline_triangle8_precomputed, wrap_phase4, wrap_phase8, wrap01,
};
