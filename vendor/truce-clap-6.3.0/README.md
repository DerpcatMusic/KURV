...
This copy derives `CLAP_AUDIO_PORT_IS_MAIN` from each declared `BusKind`, preserving KURV's sidechain input and auxiliary-output roles instead of treating the first port as main by index.
